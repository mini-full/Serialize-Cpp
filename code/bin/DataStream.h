...
namespace Binary{
    namespace serialize{
        ...
        class DataStream{
            ...
            void write(__int32_t value);
            void write(__int64_t value);
            ...
            void read(__int32_t& value);
            void read(__int64_t& value);
            ...
            DataStream& operator<<(__int32_t value){
                write(value);
                return *this;
            }
            DataStream& operator<<(__int64_t value){
                write(value);
                return *this;
            }
        ...
        void DataStream::write(__int32_t value){
            char type = DataType::DT_INT32;
            write((char*)&type, sizeof(char));
            if (byte_order == ByteOrder::BO_BIG_ENDIAN){
                // value = _byteswap_ulong(value);
                char* first = (char*)&value;
                char* last = first + sizeof(__int32_t);
                std::reverse(first, last);
            }
            write((char*)&value, sizeof(__int32_t));
        }

        void DataStream::write(__int64_t value){
            char type = DataType::DT_INT64;
            write((char*)&type, sizeof(char));
            if (byte_order == ByteOrder::BO_BIG_ENDIAN){
                // value = _byteswap_uint64(value);
                char* first = (char*)&value;
                char* last = first + sizeof(__int64_t);
                std::reverse(first, last);
            }
            write((char*)&value, sizeof(__int64_t));
        }
        ...
        void DataStream::read(__int32_t& value){
        ...
        void DataStream::read(__int64_t& value){
