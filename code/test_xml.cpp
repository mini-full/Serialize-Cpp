...
void test_xml_pair_int_string(){
	cout << "test for xml pair<int, string>" << endl;
	XML::xmlSerialBase basePair;
	pair<int, string> p0 = {1, "Foo"};
	pair<int, string> p1;
...
void test_xml_userType(){
	...
	usr_type u1 = {1, "Foo", {1.2, 2.4, 3.6}};
	usr_type u2;
	baseUsrType.custom_serialize_xml("usr.xml", u1.num, u1.name, u1.vec);
	return ;
}
